...
{
    public partial class DavisonPage : ContentPage
    {
        ...
        public DavisonPage(IAIService aIService, IChartService chartService, ICityService cityService)
        {
        ...
        private string GenerateChart()
        {
            ...
            return chartService.GenerateDavison(new(new TimeLocation(firstDateTime.Value, firstCity.Latitude, firstCity.Longitude, firstCity.Name, firstCity.TimeZoneName)
